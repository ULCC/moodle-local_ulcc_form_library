...
$duplicate = $PARSER->optional_param('duplicate', null, PARAM_INT);
...
$PAGE->set_url(new moodle_url('/local/ulcc_form_library/actions/view_forms.php'), $PARSER->get_params_url());
