...
class form_element_plugin_comment_editor extends form_element_plugin {
    ...
    function language_strings(&$string) {
        $string['form_element_plugin_comment_editor'] = 'Grade comment editor';
        $string['form_element_plugin_comment_editor_type'] = 'Grade comment editor';
        $string['form_element_plugin_comment_editor_description'] = 'A grade comment editor';
        $string['form_element_plugin_comment_editor_minimumlength'] = 'Minimum Length';
        $string['form_element_plugin_comment_editor_maximumlength'] = 'Maximum Length';
        $string['form_element_plugin_comment_editor_maxlengthrange'] =
            'The maximum length field must have a value between 0 and 255';
        $string['form_element_plugin_comment_editor_maxlessthanmin'] =
