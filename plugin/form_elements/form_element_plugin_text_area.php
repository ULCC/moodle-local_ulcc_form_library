...
class form_element_plugin_text_area extends form_element_plugin {
    ...
    function __construct() {
    	$this->tablename = "ulcc_form_plg_are";
    	$this->data_entry_tablename = "ulcc_form_plg_are_ent";
    ...
    public function install() {
        ...
        $table_key = new $this->xmldb_key('textareaplugin_unique_formfield');
    ...
    public function audit_type() {
        return get_string('form_element_plugin_text_area_type','local_ulcc_form_library');
    }
    ...
    */
    function language_strings(&$string) {
        $string['form_element_plugin_text_area'] 		= 'Textarea';
        $string['form_element_plugin_text_area_type'] 	= 'Textarea';
        $string['form_element_plugin_text_area_description'] = 'A textarea field';
        $string['form_element_plugin_text_area_minimumlength'] = 'Minimum Length';
        $string['form_element_plugin_text_area_maximumlength'] = 'Maximum Length';
        $string['form_element_plugin_text_area_maxlengthrange'] = 'The maximum length field must have a value between 0 and 255';
        $string['form_element_plugin_text_area_maxlessthanmin'] = 'The maximum length field must have a greater value than the minimum length';
