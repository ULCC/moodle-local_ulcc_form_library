...
class form_entry_mform extends form_lib_form {
    ...
    function definition() {
        ...
        if (!empty($pagebreakcount) && $this->currentpage > 1)    $buttonarray[] = &$mform->createElement('submit', 'previousbutton', get_string('previous','local_ulcc_form_library'));
        ...
        if (!empty($pagebreakcount) && $this->currentpage !=  $pagebreakcount+1)    $buttonarray[] = &$mform->createElement('submit', 'nextbutton', get_string('next','local_ulcc_form_library'));
